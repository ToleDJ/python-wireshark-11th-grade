...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #show statistics
        # self.show_stats = NewButton()
        # self.show_stats.setText("Show the packets stats")
        # self.show_stats.setStyleSheet(
        #     "background-color: rgb(240, 240, 240);border-style: outset;border-width: 0px;color:blue")
        # self.show_stats.setFont(QFont('Consolas', 10, QFont.Light))
        # self.show_stats.clicked.connect(self.EvtSaveReassemble)#do function for stats
...
if __name__ == "__main__":
    ...
    import ctypes
    myappid = 'BestSniffer'  # arbitrary string
